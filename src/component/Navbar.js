...
const Navbar =()=>{
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="/">News-World</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link" aria-current="page" to="/general">Home</NavLink>
        </li>
        {/* <li className="nav-item"> <NavLink className="nav-NavLink" to="/#">About us</NavLink></li> */}
